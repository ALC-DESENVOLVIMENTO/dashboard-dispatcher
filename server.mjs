...
const publicFiles = new Set(['index.html', 'styles.css', 'layout-overrides.css', 'period-utils.js', 'spot-bonus.js', 'app.js', 'alc-logo.png', 'favicon.png', 'login.html', 'login.js']);
...
function allowedBonusCents(mode) { if (mode === 'ff') return new Set([0, 35000, 70000, 100000]); const values = new Set([0]); spotBonus.bands.forEach(band => { for (let count = 1; count <= 100; count += 1) values.add(spotBonus.bonusForCars(band.cars, count).perDispatcherCents); }); return values; }
